...
if __name__ == "__main__":
    print(give_KPIs(period = 'All', unit_equity_curve=ss_strategy_unit_equity_curve))
    #Test over whether the CAGR that I got is correct or not.
    start_series = ss_strategy_unit_equity_curve.iloc[1]
    start_date = start_series['date']
    start_value = start_series['equity']
    end_series = ss_strategy_unit_equity_curve.iloc[-1]
